...
public class Token {
    ...
    public ResponseEntity<cloud.fogbow.as.core.models.Token> createTokenValue(
        ...
        try {
            ...
            cloud.fogbow.as.core.models.Token token = new cloud.fogbow.as.core.models.Token(tokenValue);
