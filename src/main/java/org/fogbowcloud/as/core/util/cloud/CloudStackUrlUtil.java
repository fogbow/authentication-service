...
import org.fogbowcloud.as.core.tokengenerator.plugins.cloudstack.CloudStackTokenGeneratorPlugin;
...
public class CloudStackUrlUtil {
    ...
    public static void sign(URIBuilder requestEndpoint, String tokenValue) throws InvalidParameterException {
