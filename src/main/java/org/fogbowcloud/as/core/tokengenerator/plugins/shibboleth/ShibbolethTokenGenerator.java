...
public class ShibbolethTokenGenerator implements TokenGeneratorPlugin {
	...
	public ShibbolethTokenGenerator(String confFilePath) {
        ...
        try {
			this.rasPrivateKey = FogbowAuthenticationHolder.getInstance().getPrivateKey();
	...
	public String createTokenValue(Map<String, String> userCredentials) throws UnexpectedException, FogbowAsException {
		...
		String rawTokenSignature = this.fogbowAuthenticationHolder.createSignature(rawToken);
	...
	protected String generateExpirationTime() {
		return this.fogbowAuthenticationHolder.generateExpirationTime();
	}
